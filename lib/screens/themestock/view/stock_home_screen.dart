...
class StockHomeScreen extends StatefulWidget {
  @override
  _StockHomeScreenState createState() => _StockHomeScreenState();
}
  ...
  void moveTo() {
    Navigator.push<dynamic>(
      ...
      MaterialPageRoute<dynamic>(
        builder: (BuildContext context) => StockInfoScreen(),
      ),
    );
  }
    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
            color: isSelected ? Palette.nearlyBlue : Palette.nearlyWhite,
            borderRadius: const BorderRadius.all(Radius.circular(24.0)),
            border: Border.all(color: Palette.nearlyBlue)),
        child: Material(
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    letterSpacing: 0.27,
                    color:
                        isSelected ? Palette.nearlyWhite : Palette.nearlyBlue,
                  ),
                ),
              ),
            ),
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(
            width: 60,
            height: 60,
            child: Image.asset('assets/themestock/userImage.png'),
          )
        ],
      ),
    );
